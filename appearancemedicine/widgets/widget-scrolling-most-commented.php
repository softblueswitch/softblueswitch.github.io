...
//register widget
function scrolling_most_commented_widget_init()
{
	return register_widget("scrolling_most_commented_widget");
}
add_action('widgets_init', 'scrolling_most_commented_widget_init');
?>