...
//register widget
function scrolling_recent_posts_widget_init()
{
	return register_widget("scrolling_recent_posts_widget");
}
add_action('widgets_init', 'scrolling_recent_posts_widget_init');
?>