...
function medicenter_import_shop_dummy()
{
	...
	if(!is_wp_error($file))
		...
		$result["info"] = "Import file dummy-shop.xml.gz not found! Please upload import file manually into Media library. You can find this file in 'dummy content files' directory inside zip archive downloaded from ThemeForest.";
	if($result["info"]=="")
		$result["info"] = "dummy-shop.xml file content has been imported successfully!";
	$system_message = ob_get_clean();
	$result["system_message"] = $system_message;
	echo "dummy_import_start" . json_encode($result) . "dummy_import_end";
	exit();
	...
	<form class="theme_options" action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>" method="post" id="theme-options-panel">
		<div class="header">
			<div class="header_left">
				<h3>
					<a href="<?php echo esc_url(__('https://themeforest.net/user/QuanticaLabs/portfolio?ref=QuanticaLabs', 'medicenter')); ?>" title="<?php esc_html_e("QuanticaLabs", 'medicenter'); ?>">
			...
			<div class="header_right">
				<div class="description">
					<h3>
						<a href="<?php echo esc_url(__('https://themeforest.net/item/medicenter-responsive-medical-wordpress-theme/4718613?ref=QuanticaLabs', 'medicenter')); ?>" title="<?php esc_html_e("MediCenter - Medical Health Theme", 'medicenter'); ?>">
							<?php _e("MediCenter - Medical Health Theme", 'medicenter'); ?>
						</a>
					</h3>
					<h5><?php _e("Version 10.0", 'medicenter'); ?></h5>
					...
					<a class="description_link" target="_blank" href="<?php echo esc_url(__('https://themeforest.net/item/medicenter-responsive-medical-wordpress-theme/4718613?ref=QuanticaLabs', 'medicenter')); ?>"><?php _e("Theme site", 'medicenter'); ?></a>
				</div>
		...
		<div class="footer">
			<div class="footer_left">
				<ul class="social-list">
					...
					<li><a target="_blank" href="<?php echo esc_url(__('https://themeforest.net/user/QuanticaLabs?ref=QuanticaLabs', 'medicenter')); ?>" class="social-envato" title="<?php esc_html_e('Envato', 'medicenter'); ?>"></a></li>
